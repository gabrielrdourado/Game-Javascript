...
function iniciaJogo() {
	...
	if (nivel_jogo == 1) {//Tempo jogo 120 segundos
		tempo_segundos = 120;
	}

	if (nivel_jogo == 2) {//Tempo jogo 60 segundos
		tempo_segundos = 60;
	}

	if (nivel_jogo == 3) {//Tempo jogo 30 segundos
		tempo_segundos = 30;
	}
...
function situacao_jogo(baloes_inteiros) {
	if (baloes_inteiros == 0) {
		alert('Parabéns, você estourou todos balões')
		parar_jogo();
	}
}
